      ...
      <section className="bg-[#2a2a2a] dark:bg-[#1a1a1a] px-6 py-24">
        <div className="mx-auto max-w-4xl text-center space-y-8">
          ...
          <p className="font-forum text-xl md:text-2xl leading-relaxed text-white/90">
            ...
            Marta Meyer, etc. A partir desse evento, a porta da loja se abriu de
            vez e o Mercado Babilônia passou a operar de forma mais ampla, até
            encerrar suas atividades em 1997.
          </p>
          <div className="pt-8">
            <p className="text-lg md:text-xl italic text-white/80">
              Assim, o Mercado Babilônia marcou uma época com sua proposta única
              e poética. Lugar onde a cultura, o surpreendente, a arte e a
          ...
          <div className="grid md:grid-cols-2 gap-16 items-start">
            ...
            <div className="space-y-6 font-forum text-lg leading-relaxed text-foreground/80">
              ...
              <p>
                ...
                cuidadosamente escolhidas para cada pessoa. Nos primeiros anos,
                o atendimento era exclusivo, realizado sob demanda, com portas
                fechadas.
              </p>
            </div>
          </div>
